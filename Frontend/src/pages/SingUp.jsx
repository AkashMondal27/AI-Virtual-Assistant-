  ...
  return (
    <div className='w-full h-screen bg-cover flex justify-center items-center'
      ...
      <form className='w-[90%] h-130 max-w-115 bg-[#0f0e0e5f] backdrop-blur shadow-lg  rounded-2xl
        ...
        <button className='min-w-37 h-13 mt-2 bg-orange-200 rounded-full text-amber-800 text-xl
         *: font-semibold hover:bg-orange-300 shadow-2xl shadow-amber-100' disabled={loading}>
